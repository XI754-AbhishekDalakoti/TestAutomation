...
public class LoginFormTest {
	...
	public void invalidCredentials() {
		...
		signin.setEmailField("ashu@email.com");
		signin.setPasswordField("ashu");
		signin.getSignInBtn().click();

		Assert.assertTrue(signin.getAuthenticationFailedError().isDisplayed());

		signin.setEmailField("ashu@email.email");
		signin.setPasswordField("ashu");
		signin.getSignInBtn().click();

		Assert.assertTrue(signin.getAuthenticationFailedError().isDisplayed());

		signin.setEmailField("ashu@gmail.com");
		signin.setPasswordField("ashu");
		signin.getSignInBtn().click();
