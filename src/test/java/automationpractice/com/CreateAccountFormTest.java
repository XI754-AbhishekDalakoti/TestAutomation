...
public class CreateAccountFormTest {
	...
	public void authenticationPageEmailField() {
		...
		createAccount.setCreateAccountEmailField("ashu");
		createAccount.getCreateAccountBtn().click();
		...
		// Registered email
		createAccount.setCreateAccountEmailField("ashu@email.email");
		createAccount.getCreateAccountBtn().click();

		Assert.assertTrue(createAccount.getEmailBeenRegistered().isDisplayed());

		// Correct email
		createAccount.setCreateAccountEmailField("ashu@gmail.com");
		createAccount.getCreateAccountBtn().click();
	...
	public void personalInfoFields() {
		// With values
		createAccountForm.setCustomerFirstNameField("Abhishek");
		createAccountForm.setCustomerLastNameField("Dalakoti");
		createAccountForm.setCustomerEmailField("ashu@gmail.com");
	...
	public void createAccountSuccessfully() {
		...
		createAccountForm.setCustomerFirstNameField("Ashu");
		createAccountForm.setCustomerLastNameField("Dalakoti");
		createAccountForm.setCustomerPasswordField("ashu123");
